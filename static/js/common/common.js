...
var loadingSpinner = new Spinner(loadingSpinOpts);
// 弹出加载中蒙版
function popLoading(){ 
	var html = "<div style='position:absolute;height:"+$(document).height()+"px;width:100%;z-index:10000000;left:0;top:0;background-color:#000;opacity:0.1;'></div>";
	$("body").append(html);
